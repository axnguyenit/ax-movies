...
export default function Episode({ seasonNumber, episode, handleUrl, background }) {
  ...
  return (
    ...
    >
      <div className="overflow-hidden w-1/3">
        <img
          src={imageApi.w200Image(backgroundTemp)}
      ...
      <div className="text-gray-300 w-2/3 group-hover:text-red-600 duration-200">
        <h3 className="line-2 h-full p-3 text-sm break-words">{episode.name}</h3>
      </div>
    </div>
  );
}
